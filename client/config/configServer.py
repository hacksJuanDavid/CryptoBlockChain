...
class Manager:
    # Constructor
    def __init__(self):
        self.public_key = PublicKey()  # Instance of public key
        self.config_server = ConfigServer()  # Instance of ConfigServer
    ...
    def send_request(self, command, data=None):
        ...
        # Handle error
            ...
            client_socket.sendall(
                self.cryptography.encrypt_data_server(json.dumps(error_response))
            )
